...
![](../Resources/Images/wsm/r220-back-panel.png)
...
|---|---|---|---|
| 1 | iDRAC6 Enterprise port (optional) | ![](../Resources/Images/Icons/BP4 Icon.png) | Dedicated management port for the optional iDRAC6 Enterprise card. |
| 2 | VFlash media slot (optional) | ![](../Resources/Images/Icons/BP3 Icon.png) | Connects an external SD memory card for the optional iDRAC6 Enterprise card. |
| 3 | Serial connector | ![](../Resources/Images/Icons/BP1 Icon.png) | Connects a serial device to the system. |
| 4 | PCIe expansion card slot |  | Allows you to connect one low-profile PCI Express expansion card. |
| 5 | Video connector | ![](../Resources/Images/Icons/BP2 Icon.png) | Allows you to connect a VGA display to the system. |
| 6 | eSATA | ![](../Resources/Images/wsm/esata.png) | Allows you to connect additional storage devices. |
| 7 | USB connectors (2) | ![](../Resources/Images/wsm/usb-3.png) | Allow you to connect USB devices to the system. The ports are USB 3.0-compliant. |
| 8 | Ethernet connectors (2) | ![](../Resources/Images/Icons/BP6 Icon.png) | Two integrated 10/100/1000 Mbps NIC connectors. |
